package com.arat.multitenant.mastertenant.config;
...
@EnableJpaRepositories(basePackages = {"com.arat.multitenant.mastertenant.entity", "com.arat.multitenant.mastertenant.repository"},
