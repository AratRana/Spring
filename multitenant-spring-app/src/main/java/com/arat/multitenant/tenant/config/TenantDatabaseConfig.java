package com.arat.multitenant.tenant.config;
...
@ComponentScan(basePackages = { "com.arat.multitenant.tenant.repository", "com.arat.multitenant.tenant.entity" })
@EnableJpaRepositories(basePackages = {"com.arat.multitenant.tenant.repository", "com.arat.multitenant.tenant.service" },
...
public class TenantDatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        emfBean.setPackagesToScan("com.arat.multitenant");
